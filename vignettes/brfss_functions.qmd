...
> :warning: **DEPRECATED:** The functions in this vignette have been migrated to [apde.data](https://github.com/PHSKC-APDE/apde.data). Please use that package instead.
