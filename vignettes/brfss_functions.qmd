...
For example, let's see what variables are available for 2023 King County data:
...
As with `list_dataset_columns()`, by default you will receive King County data but can specify Washington State data with the `kingco = FALSE` argument.
