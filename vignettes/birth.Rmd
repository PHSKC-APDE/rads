...
**calc all years**
```{r}
birth_all <- calc(birth, what = c("preterm"), metrics = c("mean", "rse", "total", "unique.years") )
head(birth_all)
```

**calc single years**
```{r}
birth_single <- calc(birth, what = c("preterm"), metrics = c("mean", "rse", "total", "unique.years"), 
                  by = c("chi_year"))
head(birth_single)
```
...
**calc 3 year window**
```{r}
birth_window <- calc(birth, what = c("preterm"), metrics = c("mean", "rse", "total", "unique.years"), 
                  win = 3)
head(birth_window)
```
...
```{r}
birth_window <- calc(birth, what = c("preterm"), metrics = c("rate", "rse", "total", "unique.years"), 
                  win = 3, per = 1000)
head(birth_window)
```
...
birth_5y <- calc(birth, what = c("preterm_lbw"), 
                 metrics = c("mean", "rse", "numerator", "denominator", "missing", "unique.years") )
head(birth_5y)
```
...
birth_5yrate <- calc(birth, what = c("preterm_lbw"), per = 100000, 
              metrics = c("rate", "rse", "numerator", "denominator", "missing", "unique.years") )
head(birth_5yrate)
```
