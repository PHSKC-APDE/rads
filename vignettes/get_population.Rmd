...
## Installation
If you haven't yet installed [`rads`](https://github.com/PHSKC-APDE/rads), APDE's 'R Automated Data System', follow these steps:

1) Make sure devtools is installed ... `install.packages("devtools")`.

2) Install [`rads`](https://github.com/PHSKC-APDE/rads) ... `devtools::install_github("PHSKC-APDE/rads", ref = "danny", auth_token = NULL)`
