...
1) `kingco`	<< Logical vector of length 1. Identifies whether you want population estimates limited to King County. Only impacts results for geo_type in c('blk', blkgrp', 'scd', 'tract', 'zip'). Default == TRUE.
