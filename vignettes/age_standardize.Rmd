...
This is expected and **required** if you are performing analyses for a specific age group (e.g., adolescent birth rates, opioid mortality rate among working age adults, etc.)
...
```{r, warning=FALSE, message=FALSE, eval=TRUE, results='hide'}
  kcbirth <- rads.data::synthetic_birth[chi_year == 2019 & chi_geo_kc == 'King County', .(chi_age, chi_year)] 
  wabirth <- rads.data::synthetic_birth[chi_year == 2019, .(chi_age, chi_year)]
...
```{r, warning=FALSE, message=FALSE, eval=TRUE, results='hide'}
  kcpop <- apde.data::population(kingco = T, years = 2019, ages = 15:19, 
                          genders = "Female", group_by = "ages", 
                          geo_vintage = 2020, census_vintage = 2020)
  kcpop <- kcpop[, .(age, geo = geo_id, pop)] 
  
  wapop <- apde.data::population(kingco = F, years = 2019, ages = 15:19, 
                          genders = "Female", group_by = "ages", 
