...
According to your analysis, the crude King County teen birth rate is lower than (`r ex5.1[geo=="King County"]$crude.rate` vs `r ex5.1[geo=="Washington State"]$crude.rate`) the WA State teen birth rate. This relationship remains largely unchanged after age-standardization (`r ex5.1[geo=="King County"]$adj.rate` vs `r ex5.1[geo=="Washington State"]$adj.rate`).
