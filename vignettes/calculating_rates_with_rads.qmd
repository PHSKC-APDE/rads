...
As a simple example, let's assess the death rate from falls in 2019-2023, by intent.
...
Here we see that the **crude** and **adjusted** fall death rates are relatively similar. We also see that the vast majority of fall related deaths are unintentional. 

# The four steps: example 2

In this example we will calculate the adjusted rate of deaths from ***any cause*** in 2019, stratified by race. 
