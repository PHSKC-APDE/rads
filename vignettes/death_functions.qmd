...
kable(dt4[deaths >10], format = "markdown")
```
...
```{r}
#| echo: false
kable(death_multicause(), format = "markdown")
```
...
```{r}
#| echo: false
kable(head(dt10), format = "markdown")
```
...
```{r}
#| echo: false
kable(dt10.lifetable, format = "markdown")
```
