...
deaths <- deaths[chi_geo_kc == 'King County' & year %in% 2019:2023]

deaths <- deaths[, .(year, age, seattle, underlying_cod_code)]
```
...
population <- population[year %in% 2019:2023 & geo == 'King County']
...
deaths <- rads.data::synthetic_death
deaths <- deaths[year == 2019 & chi_geo_kc == 'King County']
...
population <- population[year == 2019 & geo == 'King County']
