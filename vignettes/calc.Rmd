...
birth <- birth[, .(chi_year, chi_geo_kc, chi_sex, race4, preterm, birth_weight_grams)]
birth <- birth[chi_geo_kc == 'King County' & chi_year %in% 2019:2023]
```
...
my.est <- calc(ph.data = birth, 
               what = c("preterm"), 
               where = chi_sex == "Male" & race4 == "Hispanic",
               metrics = c("mean", "rse", "numerator", "denominator"), 
               time_var = "chi_year")
print(my.est)
```
