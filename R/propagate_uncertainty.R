...
#' 
#' Example: Comparing two log-odds ratios → use "normal"
#' Example: Comparing two odds ratios → use "lognormal"
#' Example: Comparing two mortality rates (deaths per 100,000) → use "lognormal"
#' Example: Comparing two risk differences → use "normal"
#' Example: Comparing two prevalences (e.g., 0.15 vs 0.20) → use "normal"  
...
#' @importFrom stats mean median rnorm rlnorm qnorm quantile t.test sd
