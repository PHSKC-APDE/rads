...
test_that('get_population',{
  ...
  expect_equal(1077558, get_population(years = 2017, genders = "female")[]$pop ) # KC females 2017

  expect_equal(1076142, get_population(years = 2017, genders = "male")[]$pop ) # KC males 2017
